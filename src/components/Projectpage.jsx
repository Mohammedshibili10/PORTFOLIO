        ...
        <div>
            ...
            <div className=' flex-cols md:flex-cols lg:flex  gap-20 mt-10 md:mt-20 font-display md:ml-10 xl:ml-20'>
                ...
                <div className=' w-full space-y-7 mt-8 md:mt-12'>
                    ...
                    <a href={work.siteurl} target='_blank' rel='noopener noreferrer'>    <h1 className='text-sm md:text-md text-[#D3E97A] underline  underline-offset-8'>LIVE DEMO<MdArrowOutward className='w-5 h-5 ml-2 mb-1 text-[#D3E97A] inline ' /> </h1></a>
                       <a href={work.giturl}><h1 className='text-sm md:text-md text-[#D3E97A] underline  underline-offset-8'> SEE ON GITHUB<FaGithub className='w-5 h-5 ml-2 mb-1 text-[#D3E97A] inline' /> </h1></a>
                    </div>
                </div>
            </div>
            ))}
